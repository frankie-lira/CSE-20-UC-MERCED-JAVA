...
for(int a = 0; a <= nights; a += 4) {
	System.out.print();
}
if ((room == 1) && (meal == 1))  
{broomcost = (int) nights * 50.50;
pcost = (int)guests * 30 + broomcost; 
System.out.println("CHECKOUT");
System.out.println("Room Cost:\t\t"+ "$"+ broomcost);
System.out.println("Prelimary Total Cost: $" + pcost);
System.out.println("Meal Cost:");
System.out.println("AAA Discount: -$197.75\n");
System.out.println("Club Member Discount: -$225.5");
System.out.println("Total Cost of Booking: $1554.25");}

if ((room == 1) && (meal == 2)) 

{broomcost = (int) nights * 50.50;
pcost = (int)guests * 50 + broomcost;
...
if ((room == 2) && (meal == 0)) 
{broomcost = (int) nights * 75.00;
pcost = (int)guests + broomcost;
...
if ((room == 4) && (meal == 0)) {
broomcost = (int) nights * 150.25;
pcost = (int)broomcost + guests;
